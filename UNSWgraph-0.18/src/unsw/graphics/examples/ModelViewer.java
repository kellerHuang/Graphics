...
public class ModelViewer extends Application3D {
    ...
    public ModelViewer() throws IOException {
        ...
        model = new TriangleMesh("/Users/user/Desktop/graphics1/UNSWgraph-0.18/res/models/bunny.ply", true, true);
        base = new TriangleMesh("/Users/user/Desktop/graphics1/UNSWgraph-0.18/res/models/tree.ply", true, true);
    }
